...
const (
	NotificationService_GetNotificationsForUser_FullMethodName = "/notif_proto.NotificationService/GetNotificationsForUser"
)
...
func (c *notificationServiceClient) GetNotificationsForUser(ctx context.Context, in *RequestGetNotifications, opts ...grpc.CallOption) (*ResponseGetNotifications, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GetNotificationsForUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NotificationService_GetNotificationsForUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NotificationService_GetNotificationsForUser_FullMethodName,
	}
...
var NotificationService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/Notification_Service/pb/notification.proto",
}
