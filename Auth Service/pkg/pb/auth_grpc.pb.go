...
type AuthServiceClient interface {
	...
	GetEmailAndUsername(ctx context.Context, in *GetEmailAndUsernameRequest, opts ...grpc.CallOption) (*GetEmailAndUsernameResponse, error)
...
func (c *authServiceClient) GetEmailAndUsername(ctx context.Context, in *GetEmailAndUsernameRequest, opts ...grpc.CallOption) (*GetEmailAndUsernameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetEmailAndUsernameResponse)
...
type AuthServiceServer interface {
	...
	GetEmailAndUsername(context.Context, *GetEmailAndUsernameRequest) (*GetEmailAndUsernameResponse, error)
...
func (UnimplementedAuthServiceServer) GetEmailAndUsername(context.Context, *GetEmailAndUsernameRequest) (*GetEmailAndUsernameResponse, error) {
...
func _AuthService_GetEmailAndUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEmailAndUsernameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetEmailAndUsername(ctx, req.(*GetEmailAndUsernameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
